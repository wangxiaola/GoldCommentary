...
#pragma mark - 五类个性化设置，这些参数都可以不传，此时会走默认设置
    ...
    imagePickerVc.iconThemeColor = NAVIGATION_COLOR;
    imagePickerVc.naviBgColor = NAVIGATION_COLOR;
    imagePickerVc.oKButtonTitleColorNormal = NAVIGATION_COLOR;
    imagePickerVc.oKButtonTitleColorDisabled = NAVIGATION_COLOR;
    // 3. 设置是否可以选择视频/图片/原图
